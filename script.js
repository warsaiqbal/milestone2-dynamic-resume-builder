...
function scrollToForm() {
  ...
  function updateResumePreview() {
    ...
    var emailInput =
      ((_b = document.getElementById("email")) === null || _b === void 0
        ...
        : _b.value.trim()) || "";
    var phoneInput =
      ((_c = document.getElementById("phone")) === null || _c === void 0
        ? void 0
        : _c.value.trim()) || "";
    var addressInput =
      ((_d = document.getElementById("address")) === null || _d === void 0
        ? void 0
        : _d.value.trim()) || "";
    ...
    // Education Sections
    var secondarySchoolInput =
      ((_e = document.getElementById("secondarySchool")) === null || _e === void 0
        ? void 0
        : _e.value.trim()) || "";
    var secondaryYearInput =
      ((_f = document.getElementById("secondaryYear")) === null || _f === void 0
        ? void 0
        : _f.value.trim()) || "";
    var collegeInput =
      ((_g = document.getElementById("college")) === null || _g === void 0
        ? void 0
        : _g.value.trim()) || "";
    var collegeYearInput =
      ((_h = document.getElementById("collegeYear")) === null || _h === void 0
        ? void 0
        : _h.value.trim()) || "";
    var universityInput =
      ((_j = document.getElementById("university")) === null || _j === void 0
        ? void 0
        : _j.value.trim()) || "";
    var universityYearInput =
      ((_k = document.getElementById("universityYear")) === null || _k === void 0
        ? void 0
        : _k.value.trim()) || "";
    ...
    secondarySection.style.display =
      secondarySchoolInput || secondaryYearInput ? "block" : "none";
    document.getElementById("resumeSecondarySchool").textContent =
      secondarySchoolInput;
    document.getElementById("resumeSecondaryYear").textContent =
      secondaryYearInput;
    collegeSection.style.display =
      collegeInput || collegeYearInput ? "block" : "none";
    ...
    universitySection.style.display =
      universityInput || universityYearInput ? "block" : "none";
    document.getElementById("resumeUniversity").textContent = universityInput;
    document.getElementById("resumeUniversityYear").textContent =
      universityYearInput;
    // Work Experience
    var jobTitleInput =
      ((_l = document.getElementById("jobTitle")) === null || _l === void 0
        ? void 0
        : _l.value.trim()) || "";
    var companyInput =
      ((_m = document.getElementById("company")) === null || _m === void 0
        ? void 0
        : _m.value.trim()) || "";
    var workYearsInput =
      ((_o = document.getElementById("workYears")) === null || _o === void 0
        ? void 0
        : _o.value.trim()) || "";
    ...
    // Skills
    var skillsInput =
      ((_p = document.getElementById("skills")) === null || _p === void 0
        ? void 0
        : _p.value.trim()) || "";
  ...
  function printResume() {
    var _a;
    var resumeSection =
      ((_a = document.getElementById("resumeSection")) === null || _a === void 0
        ? void 0
        : _a.innerHTML) || "";
    ...
    if (printWindow) {
      ...
      var existingStyles = stylesheets
        .map(function (style) {
  ...
  function createNewResume() {
    ...
    resumeSection.querySelectorAll("span").forEach(function (span) {
      return (span.textContent = "");
    });
    resumeSection.querySelectorAll("div").forEach(function (div) {
